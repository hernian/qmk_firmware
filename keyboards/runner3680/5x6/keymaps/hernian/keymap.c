...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_COLMAK] = LAYOUT(
      ...
      KC_BSPC, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
               KC_MLCK, KC_LGUI, KC_LALT, KC_LOWR, KC_LSFT, KC_LCTL, KC_RAIS, KC_SPC,  KC_NFER, KC_RCTL, KC_RGUI, KC_MLCK,
               KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_SPC,  KC_RCTL, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO
      ),
  [LAYER_LOWER] = LAYOUT(
      ...
      KC_DEL,  KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_MINS,                   KC_PLUS, KC_EQL,  KC_COMM, KC_DOT,  KC_SLSH, KC_NO,
               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
      ),
  [LAYER_RAISE] = LAYOUT(
      KC_CAPS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_INS,  KC_NO,   KC_BSPC, KC_DEL,  KC_NO,   KC_PSCR,
      KC_NO,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,                    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO,   KC_NO,
      KC_NO,   KC_F11,  KC_F12,  KC_PAUS, KC_NO,   KC_NO,                     KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_NO,   KC_NO,
               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
      ),
  [LAYER_IMM] = LAYOUT(
      KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                     KC_NO,   KC_ZNHN, KC_HIRA, KC_EISU, KC_NO,   KC_NO,
      KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                     KC_NO,   KC_NO,   KC_NFER, KC_XFER, KC_NO,   KC_NO,
      KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                     KC_NO,   KC_CFHR, KC_CFKT, KC_CFES, KC_CHES, KC_NO,
               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
      )
};
